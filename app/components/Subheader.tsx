    ...
    return (
        <div className="container mx-auto p-4 pt-20">
            ...
            <div className="flex justify-between items-center mb-4">
                <span className="text-blue-500 cursor-pointer">&larr; See all properties</span>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white rounded-lg shadow-lg w-96 p-6">
                        ...
                        />
                            <div>
                                <h3 className="text-lg font-semibold">Share Your Vacation Story</h3>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <button className="flex flex-col items-center p-2 text-gray-700" onClick={copyToClipboard} >
